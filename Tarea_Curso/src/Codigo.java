...
public class Codigo {
     ...
     public void Interfaz (){
        ...
        do {
            try {
                   ...
                   System.out.println("6. Generar factura y actualizar");
    ...
    public void RealizarFacturacion (){
        if(aparatos.isEmpty()){
            System.out.println("No se puede generar una factura porque no hay elementos agregados!");
            System.out.println("________________________________________________________________\n");
        }else{
    ...
    public void FacturaAparato(){
        try (BufferedWriter escribir = new BufferedWriter(new FileWriter("facturaAparatos.txt"))) {
            ...
            escribir.write("CONSUMO TOTAL DEL MES DE "+mes+": "+Total);
            escribir.newLine();
            escribir.write("________________________________________________________________\n");
            escribir.newLine();
